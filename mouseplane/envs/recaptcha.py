...
class MousePlaneEnv(gym.Env):
    ...
    def __init__(self, agent_pos=None, goal_pos=None, goal_size=None, width=10, height=10, max_steps=100, step_size = 5):
    ...
    def reset(self):
        ...
        ag.moveTo(random.randrange(100, 900), random.randrange(300, 700))
    ...
    def step(self, action):
        ...
        # Reward based on num of actions taken and dist minimization
        self.reward -= 0.01
        step_reward = self.reward - self.prev_reward
        self.prev_reward = self.reward
